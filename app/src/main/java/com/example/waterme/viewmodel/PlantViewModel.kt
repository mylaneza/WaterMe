...
class PlantViewModel(application: Application): ViewModel() {
    ...
    internal fun scheduleReminder(
        ...
        //  instance
        val waterNotification = OneTimeWorkRequestBuilder<WaterReminderWorker>().setInitialDelay(duration,unit).build()
        // TODO: Enqueue the request as a unique work request
        workerManager.enqueueUniqueWork(plantName,ExistingWorkPolicy.REPLACE,waterNotification)
    }
}
